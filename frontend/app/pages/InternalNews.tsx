...
const NEWS_ITEMS = [
  {
    ...
    excerpt: "Building on our success in Kenya and Nigeria, Lifewood is establishing new delivery centers in Ethiopia, Mozambique, Senegal, Cote d'Ivoire, and Zambia.",
    date: "March 18, 2026",
    readTime: "4 min read",
    featured: true,
  },
...
const CATEGORY_COLORS: Record<string, { bg: string; text: string }> = {
  "Company Updates": { bg: "rgba(4,98,65,0.08)", text: "#046241" },
  "AI & Technology": { bg: "rgba(255,195,112,0.22)", text: "#133020" },
  "Community": { bg: "#fdf4ff", text: "#133020" },
  "Awards": { bg: "rgba(255,179,71,0.2)", text: "#133020" },
  "Events": { bg: "#fef9c3", text: "#133020" },
};
...
function CategoryPill({ cat }: { cat: string }) {
  const style = CATEGORY_COLORS[cat] ?? { bg: "#F9F7F7", text: "#133020" };
  return (
    <span style={{
...
function FeaturedCard({ item }: { item: typeof NEWS_ITEMS[0] }) {
  ...
  return (
    <div
      ...
      style={{
        gridColumn: "span 2",
        background: "#046241", borderRadius: 20, padding: "52px 56px",
    ...
    >
      <div>
        <div style={{ display: "flex", gap: 10, marginBottom: 20, alignItems: "center" }}>
          ...
          <span style={{ fontSize: 11, color: "#5B6A5E" }}>{item.date}</span>
          <span style={{ fontSize: 11, color: "#5B6A5E" }}>Â·</span>
          <span style={{ fontSize: 11, color: "#5B6A5E" }}>{item.readTime}</span>
        </div>
        <h2 style={{
          ...
          ...(hovered ? { color: "#FFC370" } : {}),
        }}>
          {item.title}
        </h2>
        <p style={{ fontSize: 15, color: "#6E7D71", lineHeight: 1.75, maxWidth: 560 }}>
          {item.excerpt}
        </p>
      </div>
      <div style={{
  ...
  return (
    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 8 }}>
        <CategoryPill cat={item.category} />
        <span style={{ fontSize: 11, color: "#6E7D71", whiteSpace: "nowrap" }}>{item.readTime}</span>
      </div>
      <h3 style={{
        fontSize: 16, fontWeight: 700, color: "#133020",
        lineHeight: 1.35, margin: 0, fontFamily: "Arial, sans-serif",
        transition: "color 0.2s",
        ...(hovered ? { color: "#046241" } : {}),
      }}>
        {item.title}
      </h3>
      <p style={{ fontSize: 13, color: "#5B6A5E", lineHeight: 1.65, margin: 0, flexGrow: 1 }}>
        {item.excerpt}
      </p>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "auto", paddingTop: 8 }}>
        <span style={{ fontSize: 12, color: "#6E7D71" }}>{item.date}</span>
        <span style={{
  ...
  return (
    <div style={{ background: "#fff", minHeight: "100vh" }}>
      ...
      <section style={{ maxWidth: 1400, margin: "0 auto", padding: "72px 80px 60px" }}>
        ...
        <p style={{ fontSize: 15, color: "#133020", lineHeight: 1.8, maxWidth: 640 }}>
      ...
      {/* ï¿½"ï¿½ï¿½"ï¿½ News Feed ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ */}
      <section
        ...
        <AnimatedYouTubeEmbed
          ...
          caption={
            <div style={{ padding: "28px 28px 20px" }}>
              <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.15em", color: "#FFC370", textTransform: "uppercase", marginBottom: 10 }}>
                Featured Update
              </p>
              <h2 style={{ fontSize: "clamp(1.6rem, 3vw, 2.3rem)", fontWeight: 700, color: "#fff", fontFamily: "Arial, sans-serif", lineHeight: 1.2, margin: "0 0 10px" }}>
          ...
          {CATEGORIES.map(cat => (
            <button
              ...
              style={{
                ...
                borderColor: activeCategory === cat ? "#133020" : "rgba(19,48,32,0.16)",
                background: activeCategory === cat ? "#133020" : "#fff",
                color: activeCategory === cat ? "#fff" : "#133020",
              }}
            >
              {cat}
            </button>
      ...
      {/* ï¿½"ï¿½ï¿½"ï¿½ Newsletter CTA ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ */}
      <section style={{
        background: "#046241",
