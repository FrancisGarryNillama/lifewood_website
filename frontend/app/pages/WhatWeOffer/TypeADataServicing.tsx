...
const CAPABILITIES = [
  { icon: "📄", title: "Document Capture", body: "High-volume scanning and digitisation of physical archives, including genealogy records, newspapers, and legal documents." },
  { icon: "🔍", title: "Data Extraction", body: "AI-powered extraction of structured data from unstructured sources—names, dates, addresses, entities—across 50+ languages." },
  { icon: "🏷", title: "Labelling & Annotation", body: "Precise manual and semi-automated labelling pipelines with multi-tier quality control for text, image, and multimodal data." },
  { icon: "✅", title: "Quality Assurance", body: "Multi-level QA workflows including automated checks, human review, and statistical sampling to guarantee data accuracy." },
  { icon: "🧹", title: "Data Cleaning", body: "Normalization, deduplication, format standardisation, and noise removal to produce clean, model-ready datasets." },
  { icon: "🗂", title: "Formatting & Delivery", body: "Structured output in JSON, CSV, XML, or custom formats—delivered via API, SFTP, or directly into your data warehouse." },
];
  ...
  return (
    <div style={{ background: "#fff", minHeight: "100vh" }}>
      <section style={{ maxWidth: 1400, margin: "0 auto", padding: "72px 80px 60px" }}>
        <TabIndicator />
        <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", color: "#F5A623", background: "#fff7ed", padding: "5px 12px", borderRadius: 999, display: "inline-block", marginBottom: 16 }}>Type A</span>
        <h1 style={{ fontSize: "clamp(2.4rem, 5vw, 4rem)", fontWeight: 800, color: "#1a1a1a", marginBottom: 24, lineHeight: 1.1, fontFamily: "Georgia, serif", letterSpacing: "-0.02em" }}>Data Servicing</h1>
      ...
      <section style={{ maxWidth: 1400, margin: "0 auto", padding: "80px 80px 60px" }}>
        <div style={{ marginBottom: 48 }}>
          <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.15em", color: "#F5A623", textTransform: "uppercase" as const, marginBottom: 12 }}>What We Do</p>
          <h2 style={{ fontSize: "clamp(1.8rem, 3.5vw, 2.8rem)", fontWeight: 700, color: "#1a1a1a", fontFamily: "Georgia, serif", letterSpacing: "-0.02em", margin: 0 }}>Full-spectrum data services</h2>
        </div>
      ...
      <section style={{ maxWidth: 1400, margin: "0 auto", padding: "0 80px 100px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "start" }}>
          <div>
            <div style={{ borderRadius: 20, background: "linear-gradient(135deg, #1a1a1a 0%, #2D6A4F 100%)", height: 420, display: "flex", flexDirection: "column", justifyContent: "flex-end", padding: 40 }}>
              ...
              <h3 style={{ fontSize: 24, fontWeight: 700, color: "#fff", fontFamily: "Georgia, serif", lineHeight: 1.3, marginBottom: 12 }}>Type A – Data Servicing</h3>
          ...
          <div>
            <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.15em", color: "#F5A623", textTransform: "uppercase" as const, marginBottom: 24 }}>How It Works</p>
            {STEPS.map((step, i) => (
      ...
      <section style={{ background: "#111827", maxWidth: "calc(1400px - 160px)", margin: "0 auto 80px", borderRadius: 20, padding: "72px 80px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 40, flexWrap: "wrap" }}>
        <div style={{ maxWidth: 560 }}>
          ...
          <h2 style={{ fontSize: "clamp(1.8rem, 3vw, 2.6rem)", fontWeight: 700, color: "#fff", lineHeight: 1.2, fontFamily: "Georgia, serif", marginBottom: 16 }}>Ready to scale your data pipeline?</h2>
          <p style={{ fontSize: 15, color: "#9ca3af", lineHeight: 1.75, margin: 0 }}>Tell us about your project. Our solutions team will respond within one business day.</p>
        </div>
