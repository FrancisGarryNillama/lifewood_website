...
const DATA_TYPES = [
  { icon: "AV", title: "Audio & Voice", body: "Native speaker recordings, transcription, utterance collection, voice categorisation, and music metadata across 50+ languages." },
  { icon: "IV", title: "Image & Vision", body: "Collection, labelling, classification, object detection and tagging for computer vision and multimodal model training." },
  { icon: "TN", title: "Text & NLP", body: "Corpus collection, annotation, sentiment analysis, named entity recognition, and instruction-tuning dataset creation." },
  { icon: "VD", title: "Video", body: "Video collection, scene labelling, subtitle generation, activity recognition, and live broadcast annotation." },
  { icon: "MM", title: "Multimodal", body: "Cross-modal alignment, vision-language pairing, and instruction-tuning datasets for deep learning and LLMs." },
  { icon: "MT", title: "Model Testing", body: "Red-teaming, adversarial dataset creation, benchmark construction, and human preference ranking for RLHF pipelines." },
];
  ...
  return (
    <div style={{ borderBottom: "1px solid rgba(255,255,255,0.10)" }}>
      <button onClick={onToggle} style={{ width: "100%", display: "flex", alignItems: "center", gap: 20, padding: "24px 0", background: "none", border: "none", cursor: "pointer", textAlign: "left" }}>
        <span style={{ fontSize: 11, fontWeight: 700, color: "#FFC370", background: "rgba(245,166,35,0.15)", padding: "4px 10px", borderRadius: 6, letterSpacing: "0.06em", flexShrink: 0 }}>{num}</span>
        <span style={{ fontSize: 17, fontWeight: 700, color: open ? "#FFC370" : "#fff", fontFamily: "Arial, sans-serif", flex: 1, transition: "color 0.2s" }}>{label}</span>
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style={{ transform: open ? "rotate(180deg)" : "none", transition: "transform 0.25s", flexShrink: 0 }}>
          <path d="M4 6L8 10L12 6" stroke="#5B6A5E" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      </button>
      <div style={{ overflow: "hidden", maxHeight: open ? 200 : 0, transition: "max-height 0.35s ease" }}>
        <p style={{ fontSize: 14, color: "#6E7D71", lineHeight: 1.75, paddingBottom: 24, margin: 0 }}>{content}</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div style={{ background: "#fff", minHeight: "100vh" }}>
      ...
      <section style={{ maxWidth: 1400, margin: "0 auto", padding: "72px 80px 60px" }}>
        <TabIndicator />
        <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.12em", color: "#046241", background: "rgba(4,98,65,0.08)", padding: "5px 12px", borderRadius: 999, display: "inline-block", marginBottom: 16 }}>Type B</span>
        <h1 style={{ fontSize: "clamp(2.4rem, 5vw, 4rem)", fontWeight: 800, color: "#133020", marginBottom: 24, lineHeight: 1.1, fontFamily: "Arial, sans-serif", letterSpacing: "-0.02em" }}>Horizontal LLM Data</h1>
      ...
      {/* ï¿½"ï¿½ï¿½"ï¿½ Featured Work Strip ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ */}
      ...
      {/* ï¿½"ï¿½ï¿½"ï¿½ Data Types Grid ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ */}
      <section style={{ maxWidth: 1400, margin: "0 auto", padding: "80px 80px 60px" }}>
        <div style={{ marginBottom: 48 }}>
          <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.15em", color: "#FFC370", textTransform: "uppercase" as const, marginBottom: 12 }}>Coverage</p>
          <h2 style={{ fontSize: "clamp(1.8rem, 3.5vw, 2.8rem)", fontWeight: 700, color: "#133020", fontFamily: "Arial, sans-serif", letterSpacing: "-0.02em", margin: 0 }}>Every modality. Every language.</h2>
        </div>
      ...
      {/* ï¿½"ï¿½ï¿½"ï¿½ Case Study (dark) ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ï¿½"ï¿½ */}
      <section style={{ background: "#046241", padding: "80px 0" }}>
        <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 80px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "start" }}>
            <div>
              <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.15em", color: "#FFC370", textTransform: "uppercase" as const, marginBottom: 20 }}>Case Study</p>
              <h2 style={{ fontSize: "clamp(1.8rem, 3vw, 2.6rem)", fontWeight: 700, color: "#fff", fontFamily: "Arial, sans-serif", lineHeight: 1.2, marginBottom: 20 }}>
                Type B: AI Data Project (Audio)
              </h2>
              <p style={{ fontSize: 15, color: "#6E7D71", lineHeight: 1.75, marginBottom: 36 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
                {[
                  ...
                  <div key={label}>
                    <div style={{ fontSize: 28, fontWeight: 800, color: "#fff", fontFamily: "Arial, sans-serif" }}>{value}</div>
                    <div style={{ fontSize: 12, color: "#5B6A5E", marginTop: 4 }}>{label}</div>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section style={{ maxWidth: "calc(1400px - 160px)", margin: "80px auto", background: "#F9F7F7", borderRadius: 20, padding: "72px 80px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 40, flexWrap: "wrap", border: "1px solid rgba(19,48,32,0.16)" }}>
        <div style={{ maxWidth: 560 }}>
          ...
          <h2 style={{ fontSize: "clamp(1.8rem, 3vw, 2.6rem)", fontWeight: 700, color: "#133020", lineHeight: 1.2, fontFamily: "Arial, sans-serif", marginBottom: 16 }}>Need a large-scale multilingual dataset?</h2>
          <p style={{ fontSize: 15, color: "#5B6A5E", lineHeight: 1.75, margin: 0 }}>We mobilize global native-speaking workforces to deliver any language, any modality, at any scale.</p>
        </div>
